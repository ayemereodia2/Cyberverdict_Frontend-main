...
const MyfeedsRoute = () => {
  ...
  useEffect(() => {
    const getRssFeeds = async () => {
      try {
        // Check if data is available in localStorage
        const cachedData = sessionStorage.getItem("rssPostsDataDiscover");
        if (cachedData) {
  ...
  useEffect(() => {
    const getSiteDetails = async () => {
      try {
        const cachedData = sessionStorage.getItem("rssWebsitesDataDiscover");
        if (cachedData) {
