...
const PostCard: React.FC<PostCardProps> = ({
  ...
  return (
    <div className="lg:basis-[300px] rounded-lg overflow-hidden border flex flex-col border-[#EDEDED]">
      <Link className=" flex-1" to={`/post/${title}`}>
        <img className="h-44 w-full" src={image} alt="post image" />
        <div className="px-4 h-full py-2.5 flex flex-col gap-3">
          <p className="font-bold leading-6 text-[#101010]">
          ...
          <p className="text-xs leading-5">
            ...
            <span className="text-primaryColor">
              {calculateReadingTime(contentSnippet)}
            </span>
          </p>
          <p className="text-xs text-[#49454F] leading-5 tracking-wide">
            {truncateText(contentSnippet, 100)}
          </p>
          <hr />
          <div className="flex self-end flex-row w-full justify-between items-center">
            <div>
              <span>
                <img className="w-6 h-6" src={logoSvg} alt="logo image" />
              </span>
            </div>
